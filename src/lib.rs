...
impl PromiseA {
    pub fn call_b(&mut self, account_id: ValidAccountId) -> Promise {
        ...
        let another_call = Promise::new(env::current_account_id()).function_call(
        ...
        promise_a.then(callback_a.clone());
        // function returns the result of the callback
        callback_a
    }

    pub fn callback_receiver(&mut self, #[callback] promise_a_result: String ) -> String {
        log!(
